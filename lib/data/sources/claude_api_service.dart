...
class ClaudeApiService {
  ...
  String _faceSystemPrompt() {
    return '''
Sen Rise Up uygulamasının PROFESYONEL yüz estetiği & harmoni analiz motorusun.
...
''';
  ...
  String _bodySystemPrompt(IntakeProfile? p) {
    ...
    return '''
Sen Rise Up uygulamasının PROFESYONEL vücut kompozisyonu & postür analiz motorusun.
...
''';
  ...
  String _buildChatSystemPrompt(String scenario, String socialLevel) {
    ...
    return '''
Sen Rise Up uygulamasının DAYGAME (gündüz tanışma) antrenörüsün. Amacın: kullanıcının (erkek) sosyal kaygıyı yenmesi ve kadınlarla rahat, özgüvenli, saygılı konuşmayı öğrenmesi.
